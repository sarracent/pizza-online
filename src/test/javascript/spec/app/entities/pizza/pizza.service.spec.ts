...
import { IPizza, Pizza, PizzaType } from 'app/shared/model/pizza.model';
...
describe('Service Tests', () => {
    describe('Pizza Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Pizza(0, 'AAAAAAA', 'AAAAAAA', 0, PizzaType.NORMAL, 'image/png', 'AAAAAAA');
        });
