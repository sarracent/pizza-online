...
import com.softplan.app.repository.OrderItemRepository;
import com.softplan.app.service.OrderItemService;
...
import com.softplan.app.domain.enumeration.OrderItemStatus;
/**
...
public class OrderItemResourceIntTest {
    ...
    private static final OrderItemStatus UPDATED_STATUS = OrderItemStatus.NOT_AVAILABLE;
    ...
    public static OrderItem createEntity(EntityManager em) {
        ...
        // Add required entity
        Pizza pizza = PizzaResourceIntTest.createEntity(em);
        em.persist(pizza);
        em.flush();
        orderItem.setPizza(pizza);
        // Add required entity
        PizzaOrder pizzaOrder = PizzaOrderResourceIntTest.createEntity(em);
