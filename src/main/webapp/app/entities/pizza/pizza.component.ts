...
export class PizzaComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.pizzaService
            ...
            .subscribe(
                (res: HttpResponse<IPizza[]>) => this.paginatePizzas(res.body, res.headers),
    ...
    trackId(index: number, item: IPizza) {
        return item.id;
    }
    ...
    private paginatePizzas(data: IPizza[], headers: HttpHeaders) {
