...
export class PizzaOrderComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.pizzaOrderService
            ...
            .subscribe(
                (res: HttpResponse<IPizzaOrder[]>) => this.paginatePizzaOrders(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/pizza-order'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IPizzaOrder) {
        return item.id;
    }
    ...
    private paginatePizzaOrders(data: IPizzaOrder[], headers: HttpHeaders) {
